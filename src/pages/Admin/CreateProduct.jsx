      ...
      <div className="container-fluid m-3 p-3"  style={{ position: "relative", top: "10rem"  }}>
        <div className="row">
          ...
          <div className="col-md-9">
            <h1 style={{color:"white",fontWeight:"bolder",fontSize:"2.5rem"}}>Create Product</h1>
            <div className="m-1 w-75"  >
              ...
              <div className="mb-3">
                <button className="btn btn-primary" onClick={handleCreate} style={{backgroundColor:"blue",fontSize:"1rem"}}>
                  CREATE PRODUCT
                </button>
              </div>
            </div>
